...
public class ToolSetting {
    ...
    public int getMaxStorePerIp() {
        return maxStorePerIp;
    }

    public void setMaxStorePerIp(int maxStorePerIp) {
        this.maxStorePerIp = maxStorePerIp;
    }
    ...
    public void setHideBrowser(boolean hideBrowser) {
    ...
    public void setPathSimple(String pathSimple) {
        this.pathSimple = pathSimple;
    }
    ...
    public String getStoreScanKey() {
        return storeScanKey;
    }

    public void setStoreScanKey(String storeScanKey) {
        this.storeScanKey = storeScanKey;
    }
